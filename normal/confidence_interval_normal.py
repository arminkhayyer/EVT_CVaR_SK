...
for alpha in alphas:
    dirs = []
    for rep in range(10):
        dirs.append("normal{}_{}".format(alpha, rep))
    ...
    df.to_csv("all_res_normal{}.csv".format(alpha))
    ...
    plt.tight_layout()
    plt.savefig("normal{}.pdf".format(alpha))
    plt.show()


    print(df_final)
    df_final.to_csv("final_result_normal{}.csv".format(alpha))
    empty_list = []
